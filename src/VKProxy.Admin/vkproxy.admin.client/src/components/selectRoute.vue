<template>
  <div style="margin-bottom: 16px;">
    <el-radio-group v-model="c" @change="(v: any) => { model = v === true ? null : new RouteData(null); }" style="margin-bottom: 16px;">
...
const c = ref(true)
const model = defineModel({ required: true, default: null as RouteData | null })
